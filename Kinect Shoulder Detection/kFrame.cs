...
<head>
 ...
 var codesite_token = "Yg1hzevHEH3j3ClYxekxsRaNbZo:1381443193715";
 
 
 var CS_env = {"token":"Yg1hzevHEH3j3ClYxekxsRaNbZo:1381443193715","projectHomeUrl":"/p/kinect-shoulder","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/9670661675484913303","projectName":"kinect-shoulder","profileUrl":"/u/bpapman/","assetHostPath":"https://ssl.gstatic.com/codesite/ph","domainName":null,"loggedInUserEmail":"bpapman@gmail.com","relativeBaseUrl":""};
 var _gaq = _gaq || [];
 _gaq.push(
...
<div class="headbg">
 ...
 ><u>Profile</u></a>
 | <a href="https://www.google.com/accounts/Logout?continue=https%3A%2F%2Fcode.google.com%2Fp%2Fkinect-shoulder%2Fsource%2Fbrowse%2FkFrame.cs" 
...
<table id="nav_and_rev" class="list"
 ...
 <span id="crumb_links" class="ifClosed">kFrame.cs</span>
 ...
 <a href="/p/kinect-shoulder/source/browse/kFrame.cs?edit=1"
 ...
 <li><a href="/p/kinect-shoulder/source/browse/kFrame.cs?r=7" title="Previous">&lsaquo;r7</a></li>
...
><td class="source">    public class kFrame<br></td></tr
><tr
id=sl_svn11_9
...
><td class="source">        private int frame, session;<br></td></tr
><tr
id=sl_svn11_11

 onmouseover="gutterOver(11)"

><td class="source">        private double tx, ty, tz, sx, sy, sz;<br></td></tr
><tr
id=sl_svn11_12

 onmouseover="gutterOver(12)"

><td class="source">        private string acceptable;<br></td></tr
><tr
id=sl_svn11_13

 onmouseover="gutterOver(13)"

><td class="source">        private string shoulder;<br></td></tr
><tr
id=sl_svn11_14
...
><td class="source">        public kFrame(int Session, int newFrame, string Shoulder, string Accept, double tx, double ty, double tz, double sx, double sy, double sz)<br></td></tr
><tr
id=sl_svn11_17
...
><td class="source">            this.session = Session;<br></td></tr
><tr
id=sl_svn11_19

 onmouseover="gutterOver(19)"

><td class="source">            this.frame = newFrame;<br></td></tr
><tr
id=sl_svn11_20

 onmouseover="gutterOver(20)"

><td class="source">            this.shoulder = Shoulder;<br></td></tr
><tr
id=sl_svn11_21

 onmouseover="gutterOver(21)"

><td class="source">            this.acceptable = Accept;<br></td></tr
><tr
id=sl_svn11_22

 onmouseover="gutterOver(22)"

><td class="source">            this.sx = sx;<br></td></tr
><tr
id=sl_svn11_23

 onmouseover="gutterOver(23)"

><td class="source">            this.sy = sy;<br></td></tr
><tr
id=sl_svn11_24

 onmouseover="gutterOver(24)"

><td class="source">            this.sz = sz;<br></td></tr
><tr
id=sl_svn11_25
...
><td class="source">            this.ty = ty;<br></td></tr
><tr
id=sl_svn11_27

 onmouseover="gutterOver(27)"

><td class="source">            this.tz = tz;<br></td></tr
><tr
id=sl_svn11_28
...
><td class="source">        public int getSession()<br></td></tr
><tr
id=sl_svn11_31
...
><td class="source">            return this.session;<br></td></tr
><tr
id=sl_svn11_33
...
><td class="source">        public int getFrame()<br></td></tr
><tr
id=sl_svn11_36
...
><td class="source">            return this.frame;<br></td></tr
><tr
id=sl_svn11_38
...
><td class="source">        public string getAccept()<br></td></tr
><tr
id=sl_svn11_41
...
><td class="source">            return this.acceptable;<br></td></tr
><tr
id=sl_svn11_43
...
><td class="source">        public string getShoulder()<br></td></tr
><tr
id=sl_svn11_46
...
><td class="source">            return this.shoulder;<br></td></tr
><tr
id=sl_svn11_48
...
><td class="source">        public double getSX()<br></td></tr
><tr
id=sl_svn11_52
...
><td class="source">            return this.sx;<br></td></tr
><tr
id=sl_svn11_54
...
><td class="source">        public double getSY()<br></td></tr
><tr
id=sl_svn11_57
...
><td class="source">            return this.sy;<br></td></tr
><tr
id=sl_svn11_59
...
><td class="source">        public double getSZ()<br></td></tr
><tr
id=sl_svn11_62
...
><td class="source">            return this.sz;<br></td></tr
><tr
id=sl_svn11_64
...
><td class="source">        public double getTX()<br></td></tr
><tr
id=sl_svn11_67
...
><td class="source">            return this.tx;<br></td></tr
><tr
id=sl_svn11_69
...
><td class="source">        public double getTY()<br></td></tr
><tr
id=sl_svn11_72
...
><td class="source">            return this.ty;<br></td></tr
><tr
id=sl_svn11_74
...
><td class="source">        public double getTZ()<br></td></tr
><tr
id=sl_svn11_77
...
><td class="source">            return this.tz;<br></td></tr
><tr
id=sl_svn11_79
...
<script type="text/javascript">
 ...
 <p>Change log</p>
 <div>
 <a href="/p/kinect-shoulder/source/detail?spec=svn11&amp;r=10">r10</a>
 by bpapman@gmail.com
 on Oct 1, 2013
 &nbsp; <a href="/p/kinect-shoulder/source/diff?spec=svn11&r=10&amp;format=side&amp;path=/kFrame.cs&amp;old_path=/kFrame.cs&amp;old=7">Diff</a>
 </div>
 <pre>Made it match the SQL and changed to
strings because sql uses ascii value char
storage</pre>
 </div>
 ...
 <script type="text/javascript">
 var detail_url = '/p/kinect-shoulder/source/detail?r=10&spec=svn11';
 var publish_url = '/p/kinect-shoulder/source/detail?r=10&spec=svn11#publish';
 // describe the paths of this revision in javascript.
 var changed_paths = [];
 var changed_urls = [];
 
 changed_paths.push('/kFrame.cs');
 changed_urls.push('/p/kinect-shoulder/source/browse/kFrame.cs?r\x3d10\x26spec\x3dsvn11');
 
 var selected_path = '/kFrame.cs';
 ...
 <option value="/p/kinect-shoulder/source/browse/kFrame.cs?r=10&amp;spec=svn11"
 selected="selected"
 >/kFrame.cs</option>
 ...
 <a class="ifOpened" href="/p/kinect-shoulder/source/detail?r=10&spec=svn11#publish">Publish your comments</a>
 ...
 <a href="/p/kinect-shoulder/source/detail?spec=svn11&r=7">r7</a>
 by cochrane777@gmail.com
 on Oct 1, 2013
 &nbsp; <a href="/p/kinect-shoulder/source/diff?spec=svn11&r=7&amp;format=side&amp;path=/kFrame.cs&amp;old_path=/kFrame.cs&amp;old=2">Diff</a>
 <br>
 <pre class="ifOpened">Added new changes: Torso values,
Shoulder values,
Session/Frame/Accept/Shoulder data.</pre>
 </div>
 
 <div class="closed" style="margin-bottom:3px;" >
 <a class="ifClosed" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/plus.gif" ></a>
 <a class="ifOpened" onclick="return _toggleHidden(this)"><img src="https://ssl.gstatic.com/codesite/ph/images/minus.gif" ></a>
 <a href="/p/kinect-shoulder/source/detail?spec=svn11&r=2">r2</a>
 by bpapman@gmail.com
 on Sep 24, 2013
 &nbsp; <a href="/p/kinect-shoulder/source/diff?spec=svn11&r=2&amp;format=side&amp;path=/kFrame.cs&amp;old_path=/kFrame.cs&amp;old=">Diff</a>
 <br>
 <pre class="ifOpened">dur</pre>
 </div>
 
 
 <a href="/p/kinect-shoulder/source/list?path=/kFrame.cs&start=10">All revisions of this file</a>
 </div>
 </div>
 <div class="round1"></div>
 <div class="round2"></div>
 ...
 <div><a href="//kinect-shoulder.googlecode.com/svn/kFrame.cs">View raw file</a></div>
 </div>
...
<script type="text/javascript">
 ...
 var paths = {'svn11': '/kFrame.cs'}
 codereviews = CR_controller.setup(
 {"token":"Yg1hzevHEH3j3ClYxekxsRaNbZo:1381443193715","projectHomeUrl":"/p/kinect-shoulder","assetVersionPath":"https://ssl.gstatic.com/codesite/ph/9670661675484913303","projectName":"kinect-shoulder","profileUrl":"/u/bpapman/","assetHostPath":"https://ssl.gstatic.com/codesite/ph","domainName":null,"loggedInUserEmail":"bpapman@gmail.com","relativeBaseUrl":""}, '', 'svn11', paths,
